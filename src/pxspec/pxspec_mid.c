   ...
   if(d1.foutstatus==0) 
	{
      ...
      d1.rday = da;
      sprintf (d1.filname, "/home/loco/edges/data/mro/mid/%4d/%4d_%03d_%02d_mid.acq", yr, yr, da, hr);
   }
         ...
         
{
   ...
   sprintf(filename, "/home/loco/edges/data/mro/mid/status_spectrometer.txt");
