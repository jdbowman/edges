...
//      if(mm==12) {mode = 0x1d; t=0;} // Disable active control
    ...
    //-----------------------------------------------
    status = -1;
    if ((file1 = fopen("/home/loco/edges/data/thermlog_low3.txt", "a")) == NULL) 
    {
      if ((file1 = fopen("/home/loco/edges/data/thermlog_low3.txt", "w")) == NULL) 
      {
        printf("cannot write %s\n", "/home/loco/edges/data/thermlog_low3.txt");
        return 0;
      }
      status = 1;
    } else {
